...
var Reference = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        return [2 /*return*/, (_a.value = (_b.sent()).value(),
                            _a)];
                }
            });
        });
    ...
    Reference.prototype.set = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.database.set(this.path, value)];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        value = _a.sent();
                        return [2 /*return*/, new __1.Snapshot(this, value)];
                }
            });
        });
    };
    Reference.prototype.delete = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.database.delete(this.path)];
            });
        });
    };
    return Reference;
